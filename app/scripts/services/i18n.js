...
angular.module('jxbFrontApp').service('I18n', [
    '$window',
    function($window) {
        ...
        this.setResource = _setResource;
        this.getResource = _getResource;
        this.isJsonResource = _isJsonResource;
        this.isPropertiesResource = _isPropertiesResource;
        this.i18nAdapter = _i18nAdapter;
        this.getI18NResource = _getI18NResource;
        this.i18n = _i18n;
        ...
        function _getLocale() {
            return $window.localStorage && $window.localStorage.getItem('locale') || config.locale.defaults.locale;
        }
        ...
        function _isJsonResource() {
            // Deprecated Functions
            return config.locale.suffix === '.json';
        }

        function _isPropertiesResource() {
            // Deprecated Functions
            return config.locale.suffix === '.properties';
        }
