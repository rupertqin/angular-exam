...
tinymce.PluginManager.add('drawing', function(editor) {
	...
	editor.addCommand('mceDrawing', function() {
		...
		sketchSetting.stageId = editor.id + "_" + sketchSetting.sketchType;      // set stageId dynamic
		...
		var $chosen = $editor.find("img[data-mce-selected=1]");
	...
	editor.addButton('drawing', {
		// text : 'drawing',
		title : '画板',
		cmd : 'mceDrawing'
	});

	editor.addMenuItem('drawing', {
		text : 'drawing',
		cmd : 'mceDrawing',
		context: 'view'
	});
