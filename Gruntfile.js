...
module.exports = function(grunt) {
        ...
        'bower-install': {
            app: {
                ...
                exclude: [
                  ...
                  'bower_components/tinymce_zh-CN'
                ],
        ...
        copy: {
            dist: {
                files: [{
                    ...
                    cwd: '<%= yeoman.app %>',
                    dest: '<%= yeoman.dist %>',
                    src: ['*.{ico,png,txt}', '.htaccess', '*.html', 'views/{,*/}*.html', 'bower_components/**/*', 'images/{,*/}*.{webp}', 'scripts/libs/**/*', 'fonts/*']
                }, {
                    expand: true,
                    cwd: '.tmp/images',
                    dest: '<%= yeoman.dist %>/images',
            ...
            tinymce_langs: {
                src: '<%= yeoman.app %>/bower_components/tinymce_zh-CN/index.js',
                dest: '<%= yeoman.app %>/bower_components/tinymce/langs/zh_CN.js'
            },
            frontend: {
                files: [{
                    expand: true,
    ...
    grunt.registerTask('serve', function(target) {
        ...
        grunt.task.run(['clean:server', 'copy:tinymce_langs', 'bower-install', 'concurrent:server', 'autoprefixer', 'connect:livereload', 'watch']);
    });
    ...
    grunt.registerTask('deploy', function(target) {
        if (target === 'dist') {
            return grunt.task.run(['clean:frontend', 'build', 'copy:frontdist']);
        }
